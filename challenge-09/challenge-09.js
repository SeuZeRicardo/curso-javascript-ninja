(function () {
  ...
  */
  var substraction = calculator(25, 5);
  var multiplication = calculator(33, 3);
  var division = calculator(105, 10);
  var mod = calculator(600, 6);
  ...
  /*
    ...
    chamada.
  */
  console.log('O resultado da subtração é:' + substraction(function () {
    return 25 - 5
  }));
  //O resultado da subtração é:20

  console.log('O resultado da multiplicação é:' + multiplication(function () {
    return 33 * 3
  }));
  // O resultado da multiplicação é:99

  console.log('O resultado da divisão é:' + division(function () {
    return 105 / 10
  }));
  // O resultado da divisão é:10.5
