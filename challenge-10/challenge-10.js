(function () {
  ...
  */
  function isOperatorValid(operador) {
    return typeof operation[operador] !== undefined;
  }
  /*
  ...
  */
  function showOperationMessage(numero1, operador, numero2) {
    return console.log('A operação ' + numero1 + ' ' + operador + ' ' +
      numero2);
  }
  ...
  */
  function showErrorMessage(operaFunc) {
    if (isOperatorValid(operaFunc) === false) {
      return false;
    }
  }
  ...
  */
  if (sum) {
    number1 = 10;
    number2 = 15;
    console.log(showOperationMessage(number1, operationSignal, number2), sum(
      number1, number2));
  } else {
  ...
  */  
  operationSignal-= '-';
  var substraction = calculadora(operationSignal);
  if (substraction) {
    number1 = 10;
    number2 = 15;
    console.log(showOperationMessage(number1, operationSignal, number2), substraction(
      number1, number2));
  } else {
    showErrorMessage(operationSignal);
  }
  ...
  if (multiplication) {
    number1 = 10;
    number2 = 15;
    console.log(showOperationMessage(number1, operationSignal, number2), multiplication(
      number1, number2));
  } else {
    showErrorMessage(operationSignal);
  }
  ...
  if (division) {
    number1 = 10;
    number2 = 15;
    console.log(showOperationMessage(number1, operationSignal, number2), division(
      number1, number2));
  } else {
    showErrorMessage(operationSignal);
  }
  ...
  if (mod) {
    number1 = 10;
    number2 = 15;
    console.log(showOperationMessage(number1, operationSignal, number2), mod(
      number1, number2));
  } else {
    showErrorMessage(operationSignal);
  }
