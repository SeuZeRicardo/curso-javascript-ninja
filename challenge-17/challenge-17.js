(function () {
  ...
  */
  ...
  console.log(text.replace(/Manuel Marques de Sousa/i ,'Jose Ricardo Carvalho Motta Miguel'));
  ...
  */
  ...
  console.log(text.replace(/O Centauro de Luvas/g,function (downCase) {
      return downCase.toUpperCase();
    })
  );
